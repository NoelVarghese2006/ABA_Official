    ...
    return (
        <Page isIndex={false}>
            ...
            <div className="history">
                <h1>About Us</h1>
                <p>Agape Brethren Assembly was formed in the year 2011 by the Lord, through a few like-minded brethren, to serve Him in the North Dallas region.<br /><br />
            ...
            <div className="agape">
                ...
                If you confess your sins, believe in Jesus Christ, and accept Him as the Lord of your life, you will be saved. To such that are saved, "he gave the right to be called the children of God". (John 1:12)
                </p>
            </div>
            </section>
        </Page>
